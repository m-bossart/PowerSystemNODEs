...
base_system_file = joinpath(INPUT_SYSTEM_FOLDER_NAME, "base_system_3invs_vsms_20%lossP.json")
fault_system_file = joinpath(INPUT_SYSTEM_FOLDER_NAME, "fault_library_3invs_vsms_20%lossP.json")
