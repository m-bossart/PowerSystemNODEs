...
#19th order VSM gfm model with nn current source on the output
...
#9th order reduced VSM gfm model with nn current source on the output
function gfm_reduced_nn(dx,x,p,t)
